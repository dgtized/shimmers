...
(deftest adjacency-rules
  (is (= [[["AAA" "ABB" "ABB"] (gv/vec2 -1 0) ["AAA" "BBA" "BBA"]]
          ...
          [["AAA" "BBA" "BBA"] (gv/vec2 -1 0) ["AAA" "ABB" "ABB"]]
          [["AAA" "BBA" "BBA"] (gv/vec2 0 -1) ["ABB" "ABB" "AAA"]]
          [["AAA" "BBA" "BBA"] (gv/vec2 0 -1) ["BBA" "BBA" "AAA"]]
          [["AAA" "BBA" "BBA"] (gv/vec2 0 1) ["BBA" "BBA" "AAA"]]
          [["AAA" "BBA" "BBA"] (gv/vec2 1 0) ["AAA" "ABB" "ABB"]]
          [["AAA" "BBA" "BBA"] (gv/vec2 1 0) ["ABB" "ABB" "AAA"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 -1 0) ["AAA" "BBA" "BBA"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 -1 0) ["BBA" "BBA" "AAA"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 0 -1) ["AAA" "ABB" "ABB"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 0 1) ["AAA" "ABB" "ABB"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 0 1) ["AAA" "BBA" "BBA"]]
          [["ABB" "ABB" "AAA"] (gv/vec2 1 0) ["BBA" "BBA" "AAA"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 -1 0) ["ABB" "ABB" "AAA"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 0 -1) ["AAA" "BBA" "BBA"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 0 1) ["AAA" "ABB" "ABB"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 0 1) ["AAA" "BBA" "BBA"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 1 0) ["AAA" "ABB" "ABB"]]
          [["BBA" "BBA" "AAA"] (gv/vec2 1 0) ["ABB" "ABB" "AAA"]]]
         (-> "AAAA\nABBA\nABBA\nAAAA"
             sut/str->matrix
             (sut/pattern->rotated-tiles 3)
