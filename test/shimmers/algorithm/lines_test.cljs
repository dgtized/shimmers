...
(deftest join-polygons
  ...
  (is (= (gp/polygon2 [0 0] [20 0] [20 20] [10 20] [10 10] [0 10])
  ...
  (is (= (gp/polygon2 [0 0] [10 0] [10 10] [7 10] [7 20] [3 20] [3 10] [0 10])
  ...
  (is (= (gp/polygon2 [-10 -10] [0 -10] [0 -5] [5 -5] [5 5] [-3 5] [-5 0] [-10 0])
