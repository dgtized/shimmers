...
(deftest centering
  ...
  (testing "centering around origin"
    ...
    (is (= (sut/group [(gc/circle -1 0 1) (gc/circle 1 0 1)])
           (g/center (sut/group [(gc/circle 0 0 1) (gc/circle 2 0 1)]))))
    (is (= (sut/group [(gc/circle -1 0 1) (gc/circle 1 0 1)])
           (g/center (sut/group [(gc/circle -1 0 1) (gc/circle 1 0 1)])))
        "don't move it if already centered")
  ...
  (testing "centering around 1,1"
    ...
    (is (= (sut/group [(gc/circle 0 1 1) (gc/circle 2 1 1)])
           (g/center (sut/group [(gc/circle -1 0 1) (gc/circle 1 0 1)])
                     (gv/vec2 1 1))))
    (is (= (sut/group [(gc/circle 0 1 1) (gc/circle 2 1 1)])
           (g/center (sut/group [(gc/circle 0 0 1) (gc/circle 2 0 1)])
                     (gv/vec2 1 1)))
        "only move the axis with missing translation")
