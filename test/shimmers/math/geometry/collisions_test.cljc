...
(deftest overlap?
  ...
  (t/testing "Triangle2 Rect2"
    (is (sut/overlaps? (gt/triangle2 [0 0] [0 1] [1 0]) (rect/rect 1)))
    (is (sut/overlaps? (gt/triangle2 [0 0] [0 1] [1 0]) (rect/rect 0.5 0.5 1 1)))
    (is (not (sut/overlaps? (gt/triangle2 [0 0] [0 1] [1 0]) (rect/rect 1 1 1 1)))))
  (t/testing "Triangle2 Polygon2"
    (is (sut/overlaps? (gt/triangle2 [0 10] [10 10] [10 0])
  ...
  (t/testing "Rect2 Polygon2"
    (is (sut/overlaps? (rect/rect 2) (gp/polygon2 [1 1] [2 3] [3 1] [2 0.5]))
        "overlaps")
    (is (sut/overlaps? (rect/rect 2) (gp/polygon2 [0 0] [0 2] [2 2] [2 0]))
        "contains")
    (is (sut/overlaps? (rect/rect 1 1 1 1) (gp/polygon2 [0 0] [0 2] [2 2] [2 0]))
        "contained by")
...
(deftest bounded
  ...
  (t/testing "Polygon2 Circle2"
    ...
    (is (not (sut/bounded? (gp/polygon2 [0 0] [0 10] [2 10] [2 4] [8 4] [8 10] [10 10] [10 0])
                           (gc/circle [5 6] 1)))
        "outside of polygon in concave gap")
    #_(is (not (sut/bounded? (gp/polygon2 [0 0] [0 10] [2 10] [2 4] [8 4] [8 10] [10 10] [10 0])
                             (gc/circle [5 3.5] 1)))
          "overlaps but not bounded")
    #_(is (sut/bounded? (gp/polygon2 [0 0] [0 10] [2 10] [2 4] [8 4] [8 10] [10 10] [10 0])
                        (gc/circle [5 2] 1)))
    (is (not (sut/bounded? (gp/polygon2 [0.0 0.0] [0.5 1.0] [0.0 2.0] [2.0 2.0] [2.0 0.0])
                           (gc/circle 1 1 1)))))
