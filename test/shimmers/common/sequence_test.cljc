...
(deftest rotate
  ...
  (is (= [3 1 2] (sut/rotate -1 [1 2 3])))
  (is (= [3 4 1 2] (sut/rotate 2 [1 2 3 4])))
  (is (= [2 3 4 1] (sut/rotate -3 [1 2 3 4]))))

(deftest weighted
  (is (= [] (sut/weighted)))
  (is (= [:a :a] (sut/weighted 2 :a)))
  (is (= [:a :b :b] (sut/weighted 1 :a 2 :b))))

(deftest separate
  (is (= [[] []] (sut/separate #(> % 1) [])))
  (is (= [[3 2] [1 0]] (sut/separate #(> % 1) (range 4))))
  (is (= [[2 3] [0 1]] (sut/separate #(> % 1) (vec (range 4))))))
