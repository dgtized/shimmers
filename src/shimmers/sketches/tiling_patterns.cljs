...
(defn page []
  (let [n (rand-nth [3 4 5 6])
    ...
    [:div
     [:div (adapt/all-as-svg (scene n seed palette))]
     [:p {:style {:text-align "center"}}
      "Restart the sketch for a different pattern."]
     [:div {:style {:width "80%"}}
      [:p "Patterns are generated by applying a sequence of rotations and
   reflection operations on an initial seed pattern. For the pattern above the
   seed was"]]
     [:div (adapt/all-as-svg (svg {:width 128 :height 128 :stroke "black"
